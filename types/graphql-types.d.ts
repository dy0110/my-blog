...
export type BioQueryQuery = { avatar: Maybe<{ childImageSharp: Maybe<{ fixed: Maybe<> }> }>, site: Maybe<{ siteMetadata: Maybe<Pick<SiteSiteMetadata, 'author'>> }> };
...
export type BlogPostBySlugQuery = { site: Maybe<{ siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, markdownRemark: Maybe<(
    ...
    & { frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'description' | 'tags' | 'category'>> }
  )> };
